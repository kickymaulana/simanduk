...
const STORAGE_KEY = "scan_buang_cacat_ids";
...
<template>
    ...
    <div class="flex flex-col items-center justify-center min-h-[80vh] p-4" @click="focusInput">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6 w-full max-w-4xl">
            <Card class="md:col-span-5 border-2 border-red-500/20 shadow-xl overflow-hidden">
                ...
                <CardHeader class="text-center">
                    ...
                    <p v-if="sesi" class="text-[10px] font-bold text-red-400 uppercase tracking-widest">
            ...
            <Card class="md:col-span-7 border-2 border-slate-200 shadow-xl">
                <CardHeader class="bg-red-50 border-b">
                    <CardTitle class="text-sm font-bold flex items-center gap-2">
                        <IconAlertTriangle class="size-4 text-red-600" />
                        LAPORAN CACAT (WAJIB MINIMAL 1)
                    </CardTitle>
        ...
        <div v-if="form.processing" class="fixed inset-0 bg-white/60 backdrop-blur-sm z-50 flex items-center justify-center">
            <div class="flex flex-col items-center gap-2">
                ...
                <span class="font-bold text-red-900">Memproses Data...</span>
            </div>
        </div>
    </div>
</template>
